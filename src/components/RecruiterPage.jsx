...
<header className="relative w-full h-[60vh] flex flex-col justify-center bg-black overflow-hidden">
  ...
  <div className="relative z-10 flex flex-col gap-4 pl-10 mt-28"> {/* Increased margin to move lower */}
    ...
    <div>
      <p className="text-white text-lg md:text-xl">
        <span className="font-bold text-2xl md:text-4xl">Jaanvi Choudhary - Full Stack Developer</span><br></br><br></br>
