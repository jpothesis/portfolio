  ...
  return (
    <div className="bg-[#0a1128] min-h-screen text-white flex flex-col items-center justify-start">
      ...
      <section className="pt-36 pb-16 px-4 md:px-8 flex flex-col items-center justify-center w-full">
        <div className="max-w-4xl w-full mx-auto space-y-10"> {/* Increased spacing */}

          {/* Contact Card */}
          <Card className="flex flex-col md:flex-row items-center bg-gray-900/70 border border-gray-700 rounded-xl overflow-hidden shadow-[0_0_25px_#3b82f6]"> {/* Glow only, no pop */}
          ...
          {/* Email & Call Me Buttons outside card */}
          <div className="flex flex-col sm:flex-row gap-6 mt-12 w-full max-w-md mx-auto"> {/* More gap with mt-12 */}
            <a 
