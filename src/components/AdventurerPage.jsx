    ...
    <div className="min-h-screen w-full bg-black text-white font-sans overflow-x-hidden relative">
      ...
      <section className="py-8 bg-gray-900/95">
        <div className="max-w-full mx-auto">
          <TileRow title="Today's Top Picks for Adventurer" tiles={topPicks} navigate={navigate} />
          <RectTileRow title="Continue Watching for Adventurer" tiles={continueWatching} navigate={navigate} />
        </div>
      </section>
    </div>
  );
